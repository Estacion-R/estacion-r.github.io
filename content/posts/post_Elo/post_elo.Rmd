...
```{r echo=FALSE}
     ...
     #.......................Configuración .Rmd.......................
knitr::opts_chunk$set(warning = FALSE, message = FALSE, echo =T, results = "hide")
```

_Este artículo propone indagar en un método de puntuación que permite analizar selecciones de fútbol a lo largo de la historia: el puntaje Elo. Para ello nos valdremos de R para hacer scraping web, procesamiento de datos y visualizaciones._
...
![Selección del Mundial 2006](argentina_2006.jpg){width=40%}

<br>

Selecciones que basaron su juego en el funcionamiento colectivo y otros que destacaron por tener una estrella deslumbrante.

![Selección campeona Mundial 1986](argentina_1986.jpg){width=40%}
...
elo <- read_rds("data/elo_ranks_1873-01-01_2024-04-01.rds") %>% 
...
![Selección 1957](carasucias.webp){width=50%}
...
![Selección campeona Mundial 2022](argentina_campeon_22.webp){width=50%}
